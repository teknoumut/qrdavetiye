                            ...
                            @forelse ($invoices as $inv)
                                <tr class="hover:bg-night-50 dark:hover:bg-night-700/30 transition-colors">
                                    ...
                                    <td class="py-3.5 px-4 whitespace-nowrap">
                                        ...
                                        @if($inv->is_upgrade)<span class="ml-1.5 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-300">YÜKSELTME</span>@endif
                                    </td>
