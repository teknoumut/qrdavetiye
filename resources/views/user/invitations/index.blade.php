                    ...
                    <div class="group bg-white dark:bg-night-800 rounded-2xl border border-cream-200 dark:border-night-700 border-l-4 {{ $cardBorder }} shadow-sm hover:shadow-lg hover:border-gold-200 dark:hover:border-gold-500/30 transition-all duration-300 overflow-hidden animate-scale-in hover:-translate-y-1">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex gap-2.5">
                                ...
                                <form action="{{ route('user.invitations.destroy', $inv) }}" method="POST" onsubmit="return confirm('Bu davetiyeyi silmek istediğinize emin misiniz?')" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="submit" class="px-3 py-2.5 rounded-xl text-sm font-semibold text-red-500 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 hover:bg-red-100 dark:hover:bg-red-500/20 hover:text-red-700 dark:hover:text-red-400 transition-all duration-200" title="Sil">
