    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                <button @click="dark = !dark" class="w-9 h-9 rounded-xl flex items-center justify-center text-night-400 dark:text-cream-300 hover:bg-gold-50 dark:hover:bg-gold-500/10 transition-all duration-200" title="Tema değiştir">
