                            ...
                            <form action="{{ route('user.invitations.update', $invitation) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center mb-2">
                                                ...
                                                <input type="text" id="primary_color_text" value="{{ old('primary_color', $invitation->primary_color ?: '#d4a61e') }}" readonly
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center mb-2">
                                                ...
                                                <input type="text" id="secondary_color_text" value="{{ old('secondary_color', $invitation->secondary_color ?: '#fefcf8') }}" readonly
                                                    class="flex-1 px-4 py-3 rounded-xl border border-cream-200 dark:border-night-700 bg-cream-50 dark:bg-night-900 text-night-500 dark:text-cream-400 text-sm font-mono">
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center mb-2">
                                                ...
                                                <input type="text" id="envelope_text_color_text" value="{{ old('envelope_text_color', $invitation->envelope_text_color ?: '#333333') }}" readonly
                                                    class="flex-1 px-4 py-3 rounded-xl border border-cream-200 dark:border-night-700 bg-cream-50 dark:bg-night-900 text-night-500 dark:text-cream-400 text-sm font-mono">
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center mb-2">
                                                <input type="color" name="envelope_flap_color" value="{{ old('envelope_flap_color', $invitation->envelope_flap_color ?: '#ffffff') }}"
                                                    class="w-14 h-12 rounded-xl border border-cream-200 dark:border-night-700 cursor-pointer bg-white p-0.5"
                                                    oninput="document.getElementById('envelope_flap_color_text').value = this.value; updatePaletteNow('envelope_flap')">
                                                <input type="text" id="envelope_flap_color_text" value="{{ old('envelope_flap_color', $invitation->envelope_flap_color ?: '#ffffff') }}" readonly
                                                    class="flex-1 px-4 py-3 rounded-xl border border-cream-200 dark:border-night-700 bg-cream-50 dark:bg-night-900 text-night-500 dark:text-cream-400 text-sm font-mono">
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center mb-2">
                                                <input type="color" name="envelope_bg_color" value="{{ old('envelope_bg_color', $invitation->envelope_bg_color ?: '#ffffff') }}"
                                                    class="w-14 h-12 rounded-xl border border-cream-200 dark:border-night-700 cursor-pointer bg-white p-0.5"
                                                    oninput="document.getElementById('envelope_bg_color_text').value = this.value; updatePaletteNow('envelope_bg')">
                                                <input type="text" id="envelope_bg_color_text" value="{{ old('envelope_bg_color', $invitation->envelope_bg_color ?: '#ffffff') }}" readonly
                                                    class="flex-1 px-4 py-3 rounded-xl border border-cream-200 dark:border-night-700 bg-cream-50 dark:bg-night-900 text-night-500 dark:text-cream-400 text-sm font-mono">
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        @else
                                            <p class="text-amber-600 dark:text-amber-400 text-sm mb-2 flex items-center gap-1.5">⚠️ Henüz kapak fotoğrafı yüklenmemiş. Fotoğraf seçip kaydedin.</p>
                                        @endif
                                        <label class="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-cream-200 dark:border-night-700 rounded-xl cursor-pointer bg-cream-50/50 dark:bg-night-900/50 hover:border-gold-400 hover:bg-gold-50/50 dark:hover:bg-gold-500/5 transition-all group">
                                            ...
                                            <span class="text-xs text-night-300 dark:text-night-500 mt-0.5">{{ __('Önerilen: 1200x800px (max 20MB)') }}</span>
                                        ...
                                        <div>
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <textarea name="cover_video_url" rows="3" placeholder="https://www.youtube.com/watch?v=... (her satıra bir URL)" class="w-full pl-12 pr-4 py-3.5 rounded-xl border border-cream-200 dark:border-night-700 bg-white dark:bg-night-900 text-night-700 dark:text-cream-200 placeholder:text-night-300 dark:placeholder:text-night-500 focus:border-gold-400 focus:ring-2 focus:ring-gold-200/50 dark:focus:ring-gold-500/20 outline-none transition-all text-sm">{{ $cvIsUrl ? $cv : '' }}</textarea>
                                                </div>
